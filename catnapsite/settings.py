...
SECRET_KEY = 'django-insecure-!tc&-swutzm+s53!zl&6u4$2ilan-b52()c&atc@d8!nyn1z4_'
...
WSGI_APPLICATION = 'catnapsite.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'catnapapp/static')
]
